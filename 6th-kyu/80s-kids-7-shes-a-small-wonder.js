...
she's not a real girl, but a robot living amongst us. Sure, if you 
stick around her home for a while you might see her creator open up 
her back and make a few tweaks and even see her recharge in the 
closet instead of sleeping in a bed.
...
Case shouldn't matter. Only alpha characters are valid. There's 
also a little trick here. Enjoy!
 */
class Robot {
  constructor() {
    this.learned = ["thank", "you", "for", "teaching", "me", 
                    "i", "already", "know", "the", "word",
                   "do", "not", "understand", "input"]
  }
    learnWord(word) {

      if (word.replace(/[a-zA-Z]/g, "").length > 0 || word.trim() == "")
        return "I do not understand the input"
      else if (this.learned.includes(word.toLowerCase()))
        return "I already know the word " + word;
      else 
        this.learned.push(word.toLowerCase());
