...
function narcissistic(value) {
  // take the number, turn into a string, split the digits
  // turn those string digits into numbers
  // take each digit and power it by the num of digits from the value
  // add those numbers
  // return if the sum equals the original value
  let arr = value.toString().split("").map(e => Number(e));
  let sum = 0;
