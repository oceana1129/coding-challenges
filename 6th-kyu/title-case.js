...
function titleCase(title, minorWords) {
  ...
  if (minorWords === undefined) minor = [""]
  else minor = minorWords.toLowerCase().split(" ");
  
  let newTitle = words.map((e, i) => {
    if (minor.includes(e.toLowerCase()) && i !== 0) return e.toLowerCase();
    else {
